...
$x->endcolumn();
  ...
  $x->column(9);
    $x->box('type','success');
      $x->box('title','Surat Keterangan Lulus Kuliah : '.$data_sort);
      $x->box('body','no');
      ?>
        ...
        <tbody>
          ...
          foreach ($data_eizin as $data) {
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo ADMIN; ?>sklk/<?php echo $dinas_id; ?>/<?php echo $data->biodata_eizin_id; ?>/<?php echo str_replace(' ','-',$data_sort); ?>">
               ...
               $.ajax({
                 ...
                 success : function () {
                   swal({
                     ...
                     window.location = '<?php echo ADMIN; ?>sklk/<?php echo $dinas_id; ?>/<?php echo str_replace(' ','-',$data_sort); ?>';
                   })
                 }
               })
             },400)
