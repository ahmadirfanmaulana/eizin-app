    ...
    $x->box('type','success');
      ...
      ?>
        <div class="mailbox-read-info">
                <h5>Status :
                  <?php
                  $count_at = $x->db()->query("select * from tb_attachment_type where at_type = 'SKLK' or at_type = 'semua'")->num_rows;
            ...
            <?php $x->box('footer'); ?>
              <ul class="mailbox-attachments clearfix">
                <?php
                $sql = mysqli_query($x->db(),"select * from tb_attachment_type where at_type = 'SKLK' or at_type = 'Semua'");
                $no=1;
                  ...
                  if ($row_attachment>0) {
                    ...
                    <li style="width:31.5%" title="<?php echo $at['at_nama']; ?>" data-toggle="tooltip">
                      <span class="mailbox-attachment-icon has-img">
                        <ul class="docs-pictures">
                          <li style="width:100%">
                              <div style="width:100%;height:230px;background-image:url('<?php echo URL; ?>upload/attachment/dinas<?php echo $_SESSION['dinas_id']; ?>/sklk<?php echo $data->biodata_eizin_id; ?>/<?php echo $data_attachment['attachment_file_name']; ?>');background-size:cover;background-position:center;cursor:pointer;"  >
                                <img data-original="<?php echo URL; ?>upload/attachment/dinas<?php echo $_SESSION['dinas_id']; ?>/sklk<?php echo $data->biodata_eizin_id; ?>/<?php echo $data_attachment['attachment_file_name']; ?>" class="img-thumbnail img-circle" src="" style="width:100%;height:100%;opacity:0">
                              </div>
                            </li>
                         </ul>
                        </span>
                      <div class="mailbox-attachment-info">
                        ...
                        <span class="mailbox-attachment-size">
                          ...
                          <a href="<?php echo URL; ?>upload/attachment/dinas<?php echo $_SESSION['dinas_id']; ?>/sklk<?php echo $eizin_id; ?>/<?php echo $data_attachment['attachment_file_name']; ?>" class="btn btn-default btn-xs pull-right" target="_blank" title="Download" data-toggle="tooltip">
                            <i class="fa fa-cloud-download"></i>
                          </a>
                          <a href="<?php echo URL; ?>sklk/<?php echo $data->biodata_eizin_id; ?>/edit/<?php echo $at['at_id']; ?>" class="btn btn-default btn-xs pull-right" title="Edit Lampiran" data-toggle="tooltip">
                            <i class="fa fa-pencil"></i>
                          </a>
                          <?php
                          if ($data->eizin_status == "belum dikirim") {
                            ?>
                            <a href="<?php echo URL; ?>sklk/<?php echo $data->biodata_eizin_id; ?>/hapus/<?php echo $at['at_id']; ?>" class="btn btn-default btn-xs pull-right" title="Hapus Lampiran" data-toggle="tooltip">
                    ...
                    <li style="width:31.5%" title="<?php echo $at['at_nama']; ?>" data-toggle="tooltip">
                      ...
                      <div class="mailbox-attachment-info">
                        ...
                        <span class="mailbox-attachment-size">
                          belum diinputkan
                          <a href="<?php echo URL; ?>sklk/<?php echo $data->biodata_eizin_id; ?>/input/<?php echo $at['at_id']; ?>" class="btn btn-default btn-xs pull-right"  title="Upload Lampiran" data-toggle="tooltip">
            ...
            <?php $x->box('footer'); ?>
              <div class="pull-right">
                <?php
                  ...
                  elseif ($data->eizin_status == "verifikasi 2") {
                    ?>
                    <a href="<?php echo URL; ?>sklk/print_kartu/<?php echo $data->eizin_id; ?>">
                      <button type="button" name="button" class="btn btn-success">
                        <i class="fa fa-print"></i> Print Kartu Pengambilan
                      </button>
                    </a>
                    <?php
                  }
              ...
              $.ajax({
                ...
                success : function () {
                  swal({
                    ...
                    window.location = '<?php echo URL; ?>sklk/'+data_id+'/view';
                  })
                }
              })
            },400)
