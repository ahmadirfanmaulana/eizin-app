    ...
    <?php foreach ($data_table as $data): ?>
      <form class="" action="" method="post">
        ...
        <div class="form-group">
          ...
          <textarea name="biodata_dasar" rows="8" cols="80" class="form-control" required><?php echo $data->biodata_dasar; ?></textarea>
        </div>
      <?php endforeach; ?>
    ...
    $x->box('type','success');
      ...
      <?php } ?>
        ...
        <input type="hidden" name="file_then" value="<?php echo $y->attachment_file_name; ?>">
          <button type="submit" class="btn btn-danger" name="upload" value="button">
